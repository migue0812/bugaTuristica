...
<div class="container-fluid">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-5">
        <input type="text" class="form-control" id="inputEmail3" placeholder="" value="Feria de Buga">
    </div>
  </div>
  <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label">Descripción</label>
    <div class="col-sm-10">
<textarea class="form-control" rows="5">Desde el 20 de julio del 1951, El Comité de Ganaderos y Agricultores de Buga, ha logrado permanecer como uno de los principales Centros Agropecuarios del occidente Colombiano, gracias a su destacada labor y desempeño en las actividades realizadas durante estos años. Desde entonces, se ha realizado consecutivamente La Feria Exposición Nacional Agropecuaria, convirtiéndola a la fecha en la feria más antigua de todo el país.</textarea>    
    </div>
  </div>
            <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">Fecha de Inicio</label>
    <div class="col-sm-3">
        <input type="" class="form-control" id="inputEmail3" placeholder="" value="20/07/2015">
    </div>
  </div>
            <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">Fecha de Finalización</label>
    <div class="col-sm-3">
        <input type="" class="form-control" id="inputEmail3" placeholder="" value="29/07/2015">
    </div>
  </div>
            <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">Hora</label>
    <div class="col-sm-2">
        <input type="" class="form-control" id="inputEmail3" placeholder="" value="24 Hrs">
    </div>
  </div>
            <div class="form-group">
