...
<div class="container-fluid">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-5">
        <input type="text" class="form-control" id="inputEmail3" placeholder="" value="Restaurante Doña la Lupe">
    </div>
  </div>
  <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label">Descripción</label>
    <div class="col-sm-10">
<textarea class="form-control" rows="5" value="">La Plaza Cabal se inaguró oficialmente el 6 de agosto de 1924. Esta antigua Plaza Mayor, fue diseñada y construida por Don Enrique Figueroa Fernández, a partir de la cual se desarrolló la ciudad de Guadalajara de Buga desde su traslado a este sitio en 1576; su diseño estilo Parque Europeo le da vida a su edificación, en ella se encuentra la estatua en bronce del prócer bugueño General José María Cabal Barona, uno de los mártires de la Independencia y miembro de la Expedición Botánica, obra que realizó el Escultor Fernando Rubinni.</textarea>    
    </div>
  </div>
            <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">Dirección</label>
    <div class="col-sm-5">
        <input type="text" class="form-control" id="inputEmail3" placeholder="" value="Calle 6 14-23">
    </div>
  </div>
            <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">Teléfono</label>
    <div class="col-sm-3">
        <input type="tel" class="form-control" id="inputEmail3" placeholder="" value="317 2335666">
    </div>
  </div>
            <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">Horario</label>
    <div class="col-sm-4">
        <input type="tex" class="form-control" id="inputEmail3" placeholder="" value="7:00 a.m. a 9:00 p.m">
    </div>
  </div>
            <div class="form-group">
